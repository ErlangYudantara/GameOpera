...
export const LEVELS = [
  ...
  },
  {
    ...
    suggestions: ["justify-content:", "space-around", "left", "align-items:", "flex-end", "center"],
    frogs: [{ id: "frog-1", color: "green" }, { id: "frog-2", color: "yellow" }, { id: "frog-3", color: "red" }],
  ...
  },
  {
    ...
    suggestions: ["flex-direction:", "row-reverse;", "justify-content:", "flex-end;", "column", "space-around"],
    frogs: [{ id: "frog-1", color: "green" }, { id: "frog-2", color: "yellow" }, { id: "frog-3", color: "red" }],
  ...
  },
  {
    ...
    suggestions: ["flex-direction:", "column;", "justify-content:", " flex-end;", "row-reverse", "center"],
    frogs: [{ id: "frog-1", color: "green" }, { id: "frog-2", color: "yellow" }, { id: "frog-3", color: "red" }],
  ...
  },
  {
    ...
    suggestions: ["flex-direction:", "column-reverse;", "justify-content:", "space-between;", "space-around", "column"],
    frogs: [{ id: "frog-1", color: "green" }, { id: "frog-2", color: "yellow" }, { id: "frog-3", color: "red" }],
  ...
  },
  {
    ...
    badge: "Lanjutan",
    instructions: "Pindahkan HANYA maskot <strong>kuning</strong> ke bagian bawah area menggunakan <code>align-self</code>, sementara maskot lainnya tetap di atas.",
    hint: "Gunakan <code>align-self: flex-end;</code> pada elemen maskot kuning saja. Maskot hijau dan merah tidak perlu diubah.",
  ...
  {
    id: 15,
    title: "Flex Wrap & Align Content",
    badge: "Master",
    instructions: "Bantu <strong>10 maskot</strong> ini agar berpindah ke baris baru di bagian <strong>bawah</strong> area! Gunakan <code>flex-wrap</code> agar maskot bisa wrap ke baris baru, lalu gunakan <code>align-content</code> agar semua baris turun ke bawah.",
    hint: "Gunakan <code>flex-wrap: wrap;</code> dan <code>align-content: flex-end;</code> bersama-sama. <code>align-content</code> mengontrol posisi vertikal semua baris hasil wrap.",
    suggestions: ["flex-wrap: wrap;", "align-content:", "flex-end", "flex-start"],
    frogs: [
      { id: "frog-1", color: "green" }, { id: "frog-2", color: "green" }, { id: "frog-3", color: "green" }, { id: "frog-4", color: "green" },
      { id: "frog-5", color: "yellow" }, { id: "frog-6", color: "yellow" }, { id: "frog-7", color: "yellow" },
      { id: "frog-8", color: "red" }, { id: "frog-9", color: "red" }, { id: "frog-10", color: "red" }
    ],
    targetStyle: "flex-wrap: wrap; align-content: flex-end;",
    selector: "#pond",
    defaultCode: ""
  }
];
